  ...
  return (
    <div className="bg-gray-50 relative flex-col shadow-md rounded p-6 max-w-xs md:max-w-xl">
      ...
      {/* <img
        ...
        `}
      /> */}
      <div className="pl-2 pr-2 flex-col gap-4">
        <div className="flex gap-4 align-baseline">
          <div className="bg-cyan-500 rounded text-gray-50 pt-1 pr-3 pb-1 pl-3">
            {icon}
          </div>
          {title && (
            <h6 className="text-lg mb-1 mt-2 text-gray-900 font-bold">
              {title}
            </h6>
          )}
        </div>
